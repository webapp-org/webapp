...
export const saveUser = async (req, res) => {
  try {
    ...
    // const verificationLink = `http://${domainName}:${port}/v2/user/verify/${verificationToken}`;
    const verificationLink = `https://${domainName}/v2/user/verify?token=${verificationToken}`;
